...
const TRIP = {
  ...
  bookings: [
    ...
    },
    {
      ...
      lines: [
        ...
        "⚠️ 아직 예약 확인 중 — 늦어도 9/1(화) 18:00(현지)까지 성공 여부 통보",
  ...
  places: [
    ...
    },
    {
      ...
      day: ["d1", "d2", "d3"],
      seq: { d1: 4, d2: 1, d3: 1 },
      time: { d1: "16:40", d2: "08:20", d3: "08:30" },
  ...
  checklist: [
    ...
    },
    {
      ...
      items: [
        ...
        "청의 동굴 체험 다이빙 예약 ✅ 완료 — 9/2 10:00 · 집합 09:40 · 바우처 준비",
        "청의 동굴 예약 확정 통보 확인 ❗ 9/1(화) 18:00(현지)까지 — 메신저로 옴",
