...
const TRIP = {
  ...
  days: [
    {
      ...
      dow: "월",
      title: "나하 도착 & 국제거리",
      summary: "인천 09:20 → 나하 11:50 → 렌터카 → 체크인 → 나미노우에 스노클링",
      items: [
        ...
        { time: "15:00", text: "나하 마츠야마 숙소 체크인 · 수영복 갈아입기", tag: "stay" },
        { time: "15:40", text: "🤿 나미노우에 비치 스노클링 1~2시간 (숙소에서 차 5분)\n⚠️ 개인 입수 금지 — 샵 프로그램만 가능 (1시간 30분 · 성인 4,000엔 · 장비 대여 500엔)", tag: "beach" },
        { time: "17:30", text: "샤워 · 정리 (해변 샤워 시설 이용)", tag: "beach" },
        { time: "", text: "국제거리 산책 · 저녁 (미정)", tag: "food" },
  ...
  places: [
    ...
    },
    {
      ...
      lat: 26.2213,
      lng: 127.6722,
      memo: "다이빙 스팟 ⓪ · 나하 시내 유일한 해수욕장 · 숙소에서 차 5분 · 왼쪽 안쪽이 스노클링 구역 · ⚠️ 개인 입수 금지, 샵 프로그램 예약 필요"
    },
    {
      name: "🍎 링고도 (林檎堂) 국제거리점",
      cat: "cafe",
  ...
  checklist: [
    ...
    },
    {
      ...
      items: [
        ...
        "일별 일정 확정",
        "맛집 / 식당 예약 (예약 필요한 곳)",
        "나미노우에 비치 스노클링 프로그램 예약 (개인 입수 불가)",
