...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      date: "2026-09-01",
      dow: "화",
      title: "북부 종주 — 세소코 · 고릴라촙 · 츄라우미",
      summary: "나하 왕복 편도 약 2시간 · 세소코 → 고릴라촙 → 츄라우미",
      items: [
        { time: "07:30", text: "아침 (미정)", tag: "food" },
        { time: "08:00", text: "나하 출발 · 오키나와 자동차도 (나하IC→쿄다IC, ETC 1,040엔 / 현금 1,610엔)", tag: "car" },
        { time: "09:45", text: "🤿 세소코 비치 스노클링 — 장비 지참 입수 OK · 유영 9:00~17:30\n주차 1,000엔/일 · 안전요원·샤워 있음 · 세소코 대교 건너 섬", tag: "beach" },
        { time: "12:00", text: "철수 · 샤워 · 점심 (미정 — 모토부 일대)", tag: "food" },
        { time: "13:30", text: "🤿 고릴라촙 스노클링·프리다이빙 (세소코에서 8분) — 계단 입수 · 무료주차 · 샤워 3분 100엔 · 파도 높으면 입수 금지", tag: "beach" },
        { time: "15:30", text: "츄라우미 수족관 (고릴라촙에서 19분) — 약 2시간 · 온라인 할인권 미리 구매", tag: "aquarium" },
  ...
  places: [
    ...
    },
    {
      ...
      lat: 26.6488,
      lng: 127.8550,
      memo: "다이빙 스팟 · 세소코 대교 건너 섬 · 개인 입수 OK(장비 지참) · 유영 9:00~17:30(9월) · 주차 1,000엔/일 · 안전요원·샤워 있음 · ☎ 0980-47-7000"
    },
    {
      name: "🤿 고릴라촙 (ゴリラチョップ)",
      cat: "beach",
