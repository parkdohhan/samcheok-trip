...
const TRIP = {
  ...
  days: [
    {
      ...
      dow: "월",
      title: "나하 도착 & 국제거리",
      summary: "인천 09:20 → 나하 11:50 → 국제거리·마키시 시장에서 느긋하게 → 21:00 류큐노우시",
      items: [
        ...
        { time: "13:30", text: "나하 시내로 이동 (약 25분) — 첫 운전이니 천천히 · 국제거리 근처 코인파킹에 주차\n⚠️ 캐리어는 트렁크에 넣고 잠그기 (체크인 16시 이후)", tag: "car" },
        { time: "14:00", text: "늦은 점심 (미정 — 국제거리·마키시 일대, 맛집 탭 참고)", tag: "food" },
        { time: "14:40", text: "🧺 마키시 공설시장 · 국제거리 낮 산책 — 돈키호테 구경", tag: "market" },
        { time: "", text: "🍎 링고도 국제거리점 — 사과사탕 (돈키호테 안)", tag: "cafe" },
        { time: "16:00", text: "숙소 체크인 (16:00 이후 · 스마트 도어록 셀프 체크인) · 짐 풀고 휴식", tag: "stay" },
        { time: "19:00", text: "국제거리 밤 산책 (숙소에서 도보 10분)", tag: "food" },
  ...
  places: [
    ...
    },
    {
      ...
      day: ["d1", "d2", "d3"],
      seq: { d1: 5, d2: 1, d3: 1 },
      time: { d1: "16:00", d2: "08:20", d3: "08:30" },
